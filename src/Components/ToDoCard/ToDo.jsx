...
const ToDo = ({ tasks, handleTaskCreated }) => {
  ...
  return (
    <div className={`${styles.phase}`}>
              ...
              onClick={() =>
                setCollapsedTasks((prevCollapsedTasks) => {
                  if (!prevCollapsedTasks) {
                    return tasks.todo.map((task) => task.taskId);
                  } else {
                    return [];
                  }
                })
        ...
        {tasks.todo.map((task) => (
          ...
          >
            ...
            <div className={styles.row3}>
              ...
              <div className={styles.chageButton}>
                <button onClick={() => handlePhaseChange(task.taskId, "done")}>
                  DONE
                </button>
              </div>
            </div>
      ...
      {showCreateModel ? (
        <CreateTask onClose={onClose} onTaskCreated={handleTaskCreated} />
      ) : (
        ""
      )}
    </div>
